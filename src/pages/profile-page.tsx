...
import { BadgeCheck, LoaderCircle, Mail, MapPinHouse, Save, ShieldCheck } from "lucide-react";
      ...
      <Card>
        <CardHeader>
          <div className="flex flex-wrap items-start justify-between gap-4">
            <div>
              <CardTitle>Edit resident details</CardTitle>
              <CardDescription>
                These details are stored with your resident portal record and used during
                case validation.
              </CardDescription>
            </div>
            <Button
